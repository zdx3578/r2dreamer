...
# Main Phase1A validation after the 100k follow-up run.
#
# Goal:
# - validate whether structure_change should become the promoted Phase1A path
# - keep local/direct extensions out of the main lane until structure_change
#   proves itself over a longer horizon
#
# Variants:
# - phase1a_control
...
print_git_run_metadata "$ROOT_DIR" "phase1a main ab launch"
